...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("USSR", "Leningrad", null, "7", "2");
        Map<String, List<String>> result1 = Validator.advancedValidate(address1);
        Map<String, List<String>> expected1 = new HashMap<String, List<String>>();
        ...
        Map<String, List<String>> expected2 = new HashMap<String, List<String>>();
